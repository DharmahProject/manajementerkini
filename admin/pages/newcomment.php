...
<script type="text/javascript">
   ...
   $(document).ready(function () {
	...
	function SearchNewComment(){  
	   $.ajax({  
			url:"newCommentAction/select_newcomment.php",  
			method:"POST",  
			data:{	},  
			dataType:"text",  
	...
	function confirmDelete(){
	    $.ajax({  
			 url:"newCommentAction/proses_delete.php",  
			 method:"POST",  
			 data:{id: gId },  
			 dataType:"text",  
			 success:function(data){  
				  ...
				  showSuccessMesgGrowl("Process Delete New Reply finish successfully");  
			 }  
		});  
	...
	function confirmUpdate(){
	    $.ajax({  
			 url:"newCommentAction/proses_update_status.php",  
			 method:"POST",  
			 data:{id: gId },  
			 dataType:"text",  
			 success:function(data){  
				  ...
				  showSuccessMesgGrowl("New Comment Successfully displayed on the user page");  
			 }  
		});  
	}
...
<div class="row">
	<div class="col-lg-12">
		<div style="font-size:25px; padding:10px; 10px; 10px; 0px;"> New Comment <hr></div>
	</div>
</div>
<!-- /.row -->
<div class="row">
