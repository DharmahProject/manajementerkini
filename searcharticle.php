	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
					...
					?>
						...
						<div class="blog-listing">
							<article>
								...
								<a href="?menu=detailarticle&id=<?php echo $data1['kode'] ?>">
									<h1 style="color:#000"><?php echo $data1['title'] ?></h1>
								</a>
						...
						?>
								...
								<div class="col-md-6">
									<article>
										...
										<a href="?menu=detailarticle&id=<?php echo $data1['kode'] ?>">
											<h2 style="color:#000"><?php echo $data['title'] ?></h2>
										</a>
										<hr class="title-underline">
										<div class="post-meta" style="padding-top:15px; color:#BDB76B">
				...
				<input type="hidden" id="txtCategory" value="<?php echo $_GET['category'] ?>">
				...
				if (isInView) {
					...
					$.ajax({
						...
						success: function(data) {
							...
							if (!isEmpty(data) && data.length > 100) {
